                    ...
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                        ...
                        <tbody>
                            ...
                            @foreach ($List_Classes as $My_Class)
                                <tr>
                                    <td> {{ $loop->iteration }} - <input type="checkbox"  value="{{ $My_Class->id }}" class="box1" ></td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                            ...
                                            title="{{ __('grades.Edit') }}"><i class="fa fa-edit"></i></button>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#delete{{ $My_Class->id }}"
                                            title="{{ __('grades.Delete') }}"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('Classrooms.update', 'test') }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for="Name"
                                                                class="mr-sm-2">{{ __('class.stage_name_ar') }}
                                                                :</label>
                                                        ...
                                                        <div class="col">
                                                            <label for="Name_en"
                                                                class="mr-sm-2">{{ __('class.stage_name_en') }}
                                                                :</label>
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('Classrooms.destroy', 'test') }}"
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-danger">{{ __('class.Delete') }}</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body">
                            <div class="repeater">
                                <div data-repeater-list="List_Classes">
                                    <div data-repeater-item>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <label for="Name" class="mr-sm-2">{{ __('class.Name_class') }}
                                                    :</label>
                                            ...
                                            <div class="col">
                                                <label for="Name" class="mr-sm-2">{{ __('class.Name_class_en') }}
                                                    :</label>
                                            ...
                                            <div class="col">
                                                <label for="Name_en" class="mr-sm-2">{{ __('class.Name_Grade') }}
                                                    :</label>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-dismiss="modal">{{ __('class.Close') }}</button>
                                    <button type="submit" class="btn btn-success">{{ __('class.submit') }}</button>
                                </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('delete_all') }}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                            data-dismiss="modal">{{ __('class.Close') }}</button>
                        <button type="submit" class="btn btn-danger">{{ __('class.Delete') }}</button>
                    </div>
                </form>
            </div>
        </div>
